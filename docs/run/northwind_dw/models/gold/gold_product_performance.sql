    ...
    create or replace table `portifolio-482811`.`northwind_gold`.`gold_product_performance`
...
LEFT JOIN `portifolio-482811`.`northwind_silver`.`silver_fact_orders` o ON p.product_id = o.product_id
